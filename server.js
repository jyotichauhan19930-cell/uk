...
<div style="text-align:center; width:100%; padding:10px 0; background:#fff; border-bottom:1px solid #eee;">
  <script>
    atOptions = {
      'key' : 'fde80bd6fab284a10149c1a9c76f7e60',
      'format' : 'iframe',
      'height' : 90,
      'width' : 728,
      'params' : {}
  ...
  <\/script>
  <script src="https://www.highperformanceformat.com/fde80bd6fab284a10149c1a9c76f7e60/invoke.js"><\/script>
</div>
`;
...
<div style="text-align:center; width:100%; padding:10px 0; background:#fff; margin:20px 0; border:1px solid #eee; border-radius:8px;">
  <script>
  atOptions = {
    'key' : '0a693505b60305927fd514d5484e660a',
    'format' : 'iframe',
    'height' : 60,
    'width' : 468,
    'params' : {}
...
<script src="https://www.highperformanceformat.com/0a693505b60305927fd514d5484e660a/invoke.js"></script>
</div>
`;
...
/* NAV */
nav{background:#012169;color:#fff;padding:0 1.5rem;display:flex;align-items:center;justify-content:space-between;height:60px;position:sticky;top:0;z-index:100}
nav .brand{font-size:1.25rem;font-weight:700;color:#fff}
nav .brand span{color:#c8102e}
...
/* HERO */
.hero{background:linear-gradient(135deg,#012169 0%,#001a4d 50%,#000d33 100%);color:#fff;padding:3rem 1.5rem;text-align:center}
...
.stat{text-align:center}.stat strong{display:block;font-size:1.5rem;color:#c8102e}
...
.search-bar input:focus,.search-bar select:focus{border-color:#012169}
.search-bar button{padding:.6rem 1.4rem;background:#c8102e;color:#fff;border:none;border-radius:8px;cursor:pointer;font-weight:700;font-size:.9rem}
/* FILTERS */
...
.filter-chip.active,.filter-chip:hover{background:#012169;color:#fff;border-color:#012169}
/* LAYOUT */
...
.job-card:hover{border-color:#012169;transform:translateY(-2px)}
...
.btn-apply{padding:.55rem 1.3rem;background:#012169;color:#fff;border:none;border-radius:8px;font-weight:700;font-size:.85rem;cursor:pointer;transition:background .2s}
.btn-apply:hover{background:#001a4d}
/* JOB DETAIL */
...
.btn-apply-big{padding:.85rem 2.5rem;background:#012169;color:#fff;border:none;border-radius:10px;font-weight:700;font-size:1rem;cursor:pointer;transition:background .2s}
.btn-apply-big:hover{background:#001a4d}
/* PAGINATION */
...
.pagination a:hover{border-color:#012169;color:#012169}
.pagination .current{background:#012169;color:#fff;border-color:#012169}
/* BREADCRUMB */
.breadcrumb{font-size:.82rem;color:#888;margin-bottom:1rem}
.breadcrumb a{color:#012169}
/* SITEMAP NOTE */
.info-box{background:#fff;border-radius:12px;padding:1.25rem 1.5rem;border-left:4px solid #c8102e;margin-bottom:1rem;font-size:.88rem}
/* FOOTER */
...
.modal input:focus{border-color:#012169}
.modal .btn-submit{width:100%;padding:.75rem;background:#012169;color:#fff;border:none;border-radius:8px;font-weight:700;cursor:pointer;font-size:.95rem}
.modal .btn-submit:hover{background:#001a4d}
...
${AD_TOP}
<nav>
  <a class="brand" href="/"><span>UK</span>NOVA<span>.co.uk</span></a>
  <div class="nav-links">
    <a href="/">Home</a>
...
${AD_BOTTOM}
<footer>
  &copy; 2025 UKNOVA.co.uk — <strong>100,000 Jobs</strong> across United Kingdom |
  <a href="/jobs">Browse All</a> · <a href="/jobs?type=remote">Remote Jobs</a> · <a href="/sitemap">Sitemap</a>
</footer>
<script>
function openApply(title){
  window.location.href='https://ukwing-production.up.railway.app/apply-now.html';
}
</script>
</body>
</html>`;
...
<div class="job-card">
  ...
  const websiteSchema = {
    ...
    "@type": "WebSite",
    "name": "UKNOVA.co.uk",
    "url": "https://ukwing-production.up.railway.app",
    "description": "United Kingdom's largest job portal with 100,000 job listings — remote and on-site across all regions",
    "potentialAction": {
      "@type": "SearchAction",
      "target": "https://ukwing-production.up.railway.app/jobs?q={search_term_string}",
  ...
  const body = `
<div class="hero">
  <h1>Find Your Dream Job in the <span class="accent">United Kingdom</span></h1>
  <p>100,000 verified job listings — remote & on-site — across all 4 nations</p>
  <form action="/jobs" method="get" style="display:flex;gap:.75rem;max-width:580px;margin:0 auto;flex-wrap:wrap">
    ...
    <button type="submit" style="padding:.7rem 1.5rem;background:#c8102e;color:#fff;border:none;border-radius:8px;font-weight:700;cursor:pointer">Search →</button>
  </form>
  <div class="stat-bar">
    ...
    <div class="stat"><strong>4</strong><span>Nations</span></div>
    <div class="stat"><strong>150+</strong><span>Companies</span></div>
  </div>
</div>
<div class="container">
  ${AD_MIDDLE}
  <div class="info-box">
    🇬🇧 United Kingdom's most comprehensive job board — browse <strong>50,000 remote jobs</strong> and <strong>50,000 on-site jobs</strong> across all industries.
  </div>
  ...
  res.send(renderHTML({
    title: 'UKNOVA.co.uk — 100,000 Jobs in United Kingdom | Remote & On-site',
    meta: 'Find your next job in the United Kingdom. 100,000 verified listings — 50,000 remote and 50,000 on-site jobs across all 4 nations.',
    bodyContent: body,
...
<div class="hero" style="padding:1.75rem 1.5rem">
  <h1 style="font-size:1.8rem">Browse <span class="accent">100,000 Jobs</span> in the United Kingdom</h1>
...
<div class="container">
  ...
  res.send(renderHTML({
    title: `UK Jobs — Page ${page} of ${totalPages.toLocaleString()} | UKNOVA.co.uk`,
    meta: `Browse ${TOTAL_JOBS.toLocaleString()} jobs in the United Kingdom. Page ${page}. Remote and on-site positions across all industries.`,
    bodyContent: body,
    schema: null
  }));
});
...
app.get('/jobs/:id', (req, res) => {
  ...
  if (!id || id < 1 || id > TOTAL_JOBS) {
    return res.status(404).send(renderHTML({
      title: 'Job Not Found | UKNOVA.co.uk',
      meta: 'This job listing was not found.',
      bodyContent: `<div class="container" style="text-align:center;padding:4rem 1.5rem"><h1>404 — Job Not Found</h1><p style="margin:1rem 0 2rem">This job may have been filled or removed.</p><a href="/jobs" style="color:#012169">← Browse All Jobs</a></div>`,
      schema: null
    }));
  }
...
<div class="container">
  ...
  <div class="job-detail">
    <div style="display:flex;justify-content:space-between;align-items:flex-start;flex-wrap:wrap;gap:1rem">
      ...
      <div style="display:flex;flex-direction:column;align-items:flex-end;gap:.5rem">
        ...
        <span style="font-size:.8rem;color:#888">Job ID: UK-${String(job.id).padStart(6, '0')}</span>
      </div>
    </div>
  ...
  <div style="text-align:center;margin-top:1.5rem">
    <a href="/jobs" style="color:#012169;font-weight:600">← Browse All 100,000 Jobs</a>
  </div>
</div>`;

  res.send(renderHTML({
    title: `${job.title} at ${job.company} — ${job.location} | UKNOVA.co.uk`,
    meta: `${job.title} job at ${job.company}. ${job.isRemote ? 'Remote' : job.location}. ${job.salary}. Apply now on UKNOVA.co.uk.`,
    bodyContent: body,
    schema
  }));
});
...
<sitemapindex xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">`;
  for (let i = 1; i <= totalSitemaps; i++) {
    xml += `\n<sitemap><loc>https://ukwing-production.up.railway.app/sitemap-${i}.xml</loc></sitemap>`;
  }
  xml += `\n</sitemapindex>`;
...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">`;
  for (let i = start; i <= end; i++) {
    xml += `\n<url><loc>https://ukwing-production.up.railway.app/jobs/${i}</loc><changefreq>weekly</changefreq><priority>0.8</priority></url>`;
  }
  xml += `\n</urlset>`;
  res.type('application/xml').send(xml);
});
...
app.get('/sitemap', (req, res) => {
  const body = `
<div class="container">
  <h1 style="margin-bottom:1rem">Sitemap — UKNOVA.co.uk</h1>
  ...
  <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:1rem;margin-top:1rem">
    <div class="job-card">
      ...
      <div style="display:flex;flex-direction:column;gap:.5rem;margin-top:.75rem;font-size:.88rem">
        <a href="/" style="color:#012169">🏠 Home</a>
        <a href="/jobs" style="color:#012169">📋 All Jobs (100,000)</a>
        <a href="/jobs?type=remote" style="color:#012169">🌐 Remote Jobs (50,000)</a>
        <a href="/jobs?type=onsite" style="color:#012169">🏢 On-site Jobs (50,000)</a>
      </div>
    </div>
    <div class="job-card">
      <div class="card-title">XML Sitemaps</div>
      <div style="display:flex;flex-direction:column;gap:.5rem;margin-top:.75rem;font-size:.88rem">
        <a href="/sitemap.xml" style="color:#012169">📄 Sitemap Index</a>
        <a href="/sitemap-1.xml" style="color:#012169">📄 Sitemap 1 (Jobs 1–1,000)</a>
        <a href="/sitemap-2.xml" style="color:#012169">📄 Sitemap 2 (Jobs 1,001–2,000)</a>
    ...
    <div class="job-card">
      ...
      <div style="display:flex;flex-direction:column;gap:.5rem;margin-top:.75rem;font-size:.88rem">
        <a href="/jobs/1" style="color:#012169">Job #1 (First Remote Job)</a>
        <a href="/jobs/50000" style="color:#012169">Job #50,000 (Last Remote Job)</a>
        <a href="/jobs/50001" style="color:#012169">Job #50,001 (First On-site Job)</a>
        <a href="/jobs/100000" style="color:#012169">Job #100,000 (Last On-site Job)</a>
      </div>
    </div>
  </div>
</div>`;
  ...
  res.send(renderHTML({
    title: 'Sitemap | UKNOVA.co.uk',
    meta: 'Complete sitemap of UKNOVA.co.uk with 100,000 job listings across the United Kingdom.',
    bodyContent: body,
    schema: null
  }));
});
...
Allow: /
Sitemap: https://ukwing-production.up.railway.app/sitemap.xml
Disallow: /api/`);
});
...
app.listen(PORT, () => {
  console.log(`🇬🇧 UKNOVA.co.uk running on port ${PORT}`);
  console.log(`📋 ${TOTAL_JOBS.toLocaleString()} job pages ready`);
  console.log(`🏢 ${companies.length} companies hiring in the UK`);
  console.log(`📍 ${ukLocations.length} locations across the UK`);
});
